...
public enum OptionsSpecType {
    ...
    StringArrayOption("s[]") {
        ...
        List<String> getP4CommandOptionFields(String ruleName, String serverOptionStr, Object optValue) throws OptionsException {
            List<String> p4CommandOptionFields = new ArrayList<String>();
            if (nonNull(optValue)) {
    ...
    private static final Map<String, OptionsSpecType> p4CommandOptionsMap = new HashMap<String, OptionsSpecType>();
    ...
    String getP4CommandOptionField(String ruleName, String serverOptionStr, Object optValue) throws OptionsException {
        ...
        if (nonNull(optValue)) {
            ...
            optionField = applyRule(ruleName, serverOptionStr, optValue.toString());
        }
