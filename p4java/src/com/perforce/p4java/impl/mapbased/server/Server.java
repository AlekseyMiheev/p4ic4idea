...
public abstract class Server extends HelixCommandExecutor implements IServerControl, IOptionsServer {
	...
	// p4ic4idea: an alternate on the P4PASSWD string
	/**
	 * Signals access (login) needed
	 */
	 ...
	 */
	@Override
	public String setOrUnsetServerConfigurationValue(final String name,
	                                                 final String value) throws P4JavaException {
	...
	public void getStreamingExportRecords(
			...
			final IStreamingCallback callback,
	...
	@Override
	public List<IFileSpec> getDepotFiles(final List<IFileSpec> fileSpecs,
	...
	// p4ic4idea: switch infoLines to IServerMessage
	@Override
	public List<IFileLineMatch> getMatchingLines(List<IFileSpec> fileSpecs,
	                                             String pattern, List<IServerMessage> infoLines,
	...
	public IServerMessage getLoginStatus() throws P4JavaException {
	...
	@Override
	public void login(@Jdk7Nullable final IUser user, final StringBuffer ticket, final LoginOptions opts)
			throws P4JavaException {
	...
	public List<IFileSpec> moveFile(
			...
			@Jdk7Nonnull final IFileSpec fromFile,
			@Jdk7Nonnull final IFileSpec toFile)
			throws ConnectionException, RequestException, AccessException {
	...
	@Override
	public List<IFileSpec> moveFile(
			@Jdk7Nonnull IFileSpec fromFile,
			@Jdk7Nonnull IFileSpec toFile,
			@Jdk7Nullable MoveFileOptions opts) throws P4JavaException {
	...
	public List<IObliterateResult> obliterateFiles(
			@Jdk7Nonnull final List<IFileSpec> fileSpecs,
	...
	@Override
	public String createProtectionEntries(@Jdk7Nonnull final List<IProtectionEntry> entryList)
			throws P4JavaException {
	...
	@Override
	public String updateProtectionEntries(@Jdk7Nonnull final List<IProtectionEntry> entryList)
			throws P4JavaException {
	...
	@Override
	public String createTriggerEntries(@Jdk7Nonnull final List<ITriggerEntry> entryList)
			throws P4JavaException {
	...
	@Override
	public String updateTriggerEntries(@Jdk7Nonnull final List<ITriggerEntry> entryList)
			throws P4JavaException {
