...
public class LoginDelegator extends BaseDelegator implements ILoginDelegator {
    ...
    public IServerMessage getLoginStatus() throws P4JavaException {
        ...
        // p4ic4idea: NOTE: can return null now.
        return statusStr;
    }
    ...
    public void login(final String password, final StringBuffer ticket, final LoginOptions opts)
        ...
        // exception.
        if (isNotBlank(actualPassword) && nonNull(retVal)) {
    ...
    @Override
    public void login(@Jdk7Nonnull final IUser user, final StringBuffer ticket, final LoginOptions opts)
            throws P4JavaException {
