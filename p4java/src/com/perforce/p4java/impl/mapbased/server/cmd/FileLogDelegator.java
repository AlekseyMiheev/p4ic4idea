...
public class FileLogDelegator extends BaseDelegator implements IFileLogDelegator {
    ...
    public Map<IFileSpec, List<IFileRevisionData>> getRevisionHistory(
        ...
        Map<IFileSpec, List<IFileRevisionData>> fileRevisionDataMap = new HashMap<IFileSpec, List<IFileRevisionData>>();
    ...
    private static List<FileRevisionData> parseFileRevisionDataList(
            @Jdk7Nonnull final Map<String, Object> resultMap) {

        List<FileRevisionData> fileRevisionDataList = new ArrayList<FileRevisionData>();
