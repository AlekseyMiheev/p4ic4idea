...
public class Parameters {
     ...
     */
    public static String[] processParameters(final Options opts, final List<IFileSpec> fileSpecs,
                                             final @Jdk7Nullable String[] stringParams, final boolean annotateFiles,
                                             final IServer server) throws P4JavaException {
    ...
    private static void addOpts(@Jdk7Nonnull List<String> args, @Jdk7Nullable Options opts, IServer server)
            throws P4JavaException {
        if (nonNull(opts)) {
    ...
    private static String[] addFileSpecs(@Jdk7Nonnull final List<String> args,
                                         @Jdk7Nullable final List<IFileSpec> fileSpecs) {
    ...
    private static void addFileSpec(@Jdk7Nonnull final List<String> args,
                                    @Jdk7Nullable final IFileSpec fileSpec) {
        Validate.notNull(args);
    ...
    private static String[] addUnannotatedFileSpecs(@Jdk7Nonnull final List<String> args,
                                                    @Jdk7Nullable final List<IFileSpec> fileSpecs) {
        Validate.notNull(args);
        if (nonNull(fileSpecs)) {
     ...
     * doing...
     */
    public static String[] processParameters(final Options opts, @Jdk7Nullable final IFileSpec fromFile,
                                             @Jdk7Nullable final IFileSpec toFile, final String branchSpec, final IServer server)
            throws P4JavaException {
    ...
    public static String[] processParameters(final Options opts,
                                             @Jdk7Nullable final List<IFileSpec> fromFiles, @Jdk7Nullable final List<IFileSpec> toFiles,
    ...
    private static void addFileSpecIfValidFileSpec(@Jdk7Nonnull final List<String> args,
                                                   @Jdk7Nullable final List<IFileSpec> fileSpecs) {
        Validate.notNull(args);
