...
public class UserDelegator extends BaseDelegator implements IUserDelegator {
    ...
    @Override
    public String createUser(@Jdk7Nonnull final IUser user, final boolean force)
    ...
    @Override
    public String createUser(@Jdk7Nonnull final IUser user, final UpdateUserOptions opts)
    ...
    @Override
    public String updateUser(@Jdk7Nonnull IUser user, final boolean force)
            throws ConnectionException, RequestException, AccessException {
    ...
    @Override
    public String updateUser(@Jdk7Nonnull final IUser user, final UpdateUserOptions opts)
            throws P4JavaException {
