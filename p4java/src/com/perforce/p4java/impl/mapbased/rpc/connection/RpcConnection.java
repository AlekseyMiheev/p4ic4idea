...
import static com.perforce.p4java.common.base.ObjectUtils.firstNonNull;
...
public abstract class RpcConnection {
     ...
     *             if any user-reportable error occurred under the covers.
     */
    public RpcConnection(@Jdk7Nonnull String serverHost, int serverPort, Properties props,
