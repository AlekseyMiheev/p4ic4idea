...
import com.perforce.p4java.util.compat.FilenameUtils;
...
import static com.perforce.p4java.util.compat.StringUtils.isEmpty;
...
public class WindowsRpcSystemFileCommandsHelper extends SymbolicLinkHelper {
    ...
    static {
        ...
        DEFAULT_WINDOWS_EXE_EXT = new ArrayList<String>();
    ...
    public boolean setReadable(final String fileName, final boolean readable,
        ...
        try {
            ...
            NioFiles.setAttribute(path, "dos:readonly", readable);
        } catch (IOException e) {
            return false;
        }
        return true;
