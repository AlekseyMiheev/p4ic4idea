...
public class ExtendedFileSpec extends FileSpec implements IExtendedFileSpec {
    ...
    private List<String> otherActionList = new ArrayList<String>(); // list of other
                                                              // actions on this
                                                              // file
    private List<String> otherChangelist = new ArrayList<String>(); // list of other
                                                              // change lists
                                                              // for this file
    private List<String> otherOpenList = new ArrayList<String>(); // list of other
                                                            // users with file
                                                            // open
    ...
    private Map<String, byte[]> attributes = new HashMap<String, byte[]>(); // Leave it null
                                                              // until needed...
    private Map<String, byte[]> propagatingAttributes = new HashMap<String, byte[]>(); // Leave
                                                                         // it
                                                                         // null
                                                                         // until
                                                                         // needed...
    private Map<String, byte[]> attributeTypes = new HashMap<String, byte[]>(); // Leave it
                                                                  // null until
                                                                  // needed...
    ...
    public ExtendedFileSpec(final Map<String, Object> map, final IServer server, final int index) {
        ...
        if (nonNull(map)) {
            try {
                ...
                try {
                    // p4ic4idea: add != null test
                    if (!DEFAULT.equalsIgnoreCase(CLIENT) && cList != null) {
