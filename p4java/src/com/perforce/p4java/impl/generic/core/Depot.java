...
import static com.perforce.p4java.util.compat.StringUtils.endsWith;
...
import static com.perforce.p4java.util.compat.StringUtils.upperCase;
...
import com.perforce.p4java.util.compat.FastDateFormat;
...
public class Depot extends ServerResource implements IDepot {
    ...
    private ViewMap<IMapEntry> specMap = new ViewMap<IMapEntry>();
