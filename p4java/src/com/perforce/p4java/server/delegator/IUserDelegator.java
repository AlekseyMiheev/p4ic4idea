...
public interface IUserDelegator {
     ...
     */
    String createUser(@Jdk7Nonnull IUser user, boolean force)
     ...
     */
    String createUser(@Jdk7Nonnull IUser user, UpdateUserOptions opts)
     ...
     * @throws AccessException     if the Perforce server denies access to the caller
     */
    String updateUser(@Jdk7Nonnull IUser user, boolean force)
            throws ConnectionException, RequestException, AccessException;
     ...
     * @throws P4JavaException if any error occurs in the processing of this method.
     */
    String updateUser(@Jdk7Nonnull IUser user, UpdateUserOptions opts)
            throws P4JavaException;
