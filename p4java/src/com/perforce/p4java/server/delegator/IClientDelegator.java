...
public interface IClientDelegator {
    ...
    IClient getClient(@Jdk7Nonnull IClientSummary clientSummary)
            throws ConnectionException, RequestException, AccessException;
    ...
    String createClient(@Jdk7Nonnull final IClient newClient)
            throws ConnectionException, RequestException, AccessException;

    String updateClient(@Jdk7Nonnull final IClient client)
            throws ConnectionException, RequestException, AccessException;
