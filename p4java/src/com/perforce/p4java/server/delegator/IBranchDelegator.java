...
public interface IBranchDelegator {
     ...
     *             when access to the branch command is not authorised
     */
    String createBranchSpec(@Jdk7Nonnull final IBranchSpec branchSpec)
            throws ConnectionException, RequestException, AccessException;
     ...
     *             when access to the branch command is not authorised
     */
    String updateBranchSpec(@Jdk7Nonnull final IBranchSpec branchSpec)
            throws ConnectionException, RequestException, AccessException;
     ...
     * @throws AccessException
     *             when access to the branch command is not authorised
     * @deprecated use {@link deleteBranchSpec(final String branchSpecName,
