...
public interface ITriggersDelegator {
     ...
     * @since 2014.1
     */
    String createTriggerEntries(@Jdk7Nonnull List<ITriggerEntry> entryList) throws P4JavaException;
     ...
     * @since 2014.1
     */
    String updateTriggerEntries(@Jdk7Nonnull List<ITriggerEntry> entryList) throws P4JavaException;
