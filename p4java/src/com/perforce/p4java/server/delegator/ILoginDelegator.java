...
public interface ILoginDelegator {
     ...
     * protect'", etc.
     *
     * // p4ic4idea: can now return null if no issue.
    ...
    IServerMessage getLoginStatus() throws P4JavaException;
     ...
     * @since 2011.2
     */
    void login(@Jdk7Nonnull IUser user, StringBuffer ticket, LoginOptions opts)
            throws P4JavaException;
