...
public interface IHelixCommandExecutor {
     ...
     */
    // p4ic4idea: returns IServerMessage
    @Deprecated
     ...
     */
    // p4ic4idea returning IServerMessage instead.
    @Deprecated
    IServerMessage getErrorStr(Map<String, Object> map);

    /**
     * @deprecated use {@link IServerMessage#isAuthFail()}
     */
    // p4ic4idea takes IServerMessage instead.
    @Deprecated
    boolean isAuthFail(IServerMessage errStr);
    ...
    // p4ic4idea returning IServerMessage instead.
    @Deprecated
    IServerMessage getInfoStr(Map<String, Object> map);
