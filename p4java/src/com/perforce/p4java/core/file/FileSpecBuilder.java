...
public class FileSpecBuilder {
	 ...
	 */
	public static List<IFileSpec> makeFileSpecList(@Jdk7Nullable List<String> filePaths) {
	 ...
	 */
	public static List<IFileSpec> getValidFileSpecs(@Jdk7Nullable List<IFileSpec> fileSpecs) {
		List<IFileSpec> validFileSpecs = new ArrayList<IFileSpec>();
	...
	public static List<IFileSpec> getInvalidFileSpecs(@Jdk7Nullable List<IFileSpec> fileSpecs) {
		List<IFileSpec> invalidFileSpecs = new ArrayList<IFileSpec>();
