...
public final class P4JavaExceptions {
    ...
    // p4ic4idea: extra helper method to avoid the useless getMessage() call.
    public static void throwP4JavaError(Throwable cause) throws P4JavaError {
        throw new P4JavaError(cause);
    }
    ...
    /**
     * If the check <code>msg</code> is an error; then <code>RequestException</code> will throw
     * with given error message <code>message</code>
     */
    // p4ic4idea: change error messages to use IServerMessage instead.
    public static void throwRequestExceptionOnError(IServerMessage msg) throws RequestException {
    ...
    public static void throwRequestExceptionIfPerforceServerVersionOldThanExpected(
        ...
        if (!expression) {
            String exceptionMessage = format(message, args);
            // p4ic4idea: even though this method is deprecated, it's still valid,
            // because this is an API problem, not a server problem.  However, that
            // does mean that this is probably the wrong exception to generate.
     ...
     * with given error message <code>message</code>
     */
    // p4ic4idea: take an IServerMessage
