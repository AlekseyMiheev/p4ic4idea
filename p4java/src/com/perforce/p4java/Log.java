...
public class Log {
   ...
   */
  public static void error(String errorString, @Jdk7Nullable Object... args) {
  ...
  // p4ic4idea: IServerMessage error
  public static void error(IServerMessage error) {
    if (nonNull(logCallback)) {
   ...
   */
  public static void warn(String warnString, @Jdk7Nullable Object... args) {
    if (nonNull(logCallback)) {
   ...
   */
  public static void info(String infoString, @Jdk7Nullable Object... args) {
    if (nonNull(logCallback)) {
   ...
   */
  public static void stats(String statsString, @Jdk7Nullable Object... args) {
    if (nonNull(logCallback)) {
